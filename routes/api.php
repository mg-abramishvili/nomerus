...
Route::get('cities','App\Http\Controllers\FrontController@cities_index');

Route::get('transports','App\Http\Controllers\FrontController@transports_index');
Route::get('{city}/transport/{id}/types','App\Http\Controllers\FrontController@transport_types');
